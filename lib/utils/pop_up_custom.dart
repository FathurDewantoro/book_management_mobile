...
void showPopupSucess(BuildContext context, String title, String subtitle) {
  showDialog(
    context: context,
...
void showPopupSucessLarge(BuildContext context, String title, String subtitle) {
  showDialog(
    context: context,
    builder: (BuildContext context) {
      return AlertDialog(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                    border: Border.all(color: borderPrimary50, width: 5),
...
void showPopUpTidakMemilikiKodeAktivasi(

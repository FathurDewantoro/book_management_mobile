...
import 'package:book_management_mobile/utils/popinfo.dart';
...
Future<Response?> configDio(
  ...
  try {
    ...
    if (e.response != null) {
      ...
      print(e.message);
      if (e.type == DioExceptionType.unknown && context != null) {
        PopInfo.snackbar(context, "Check Your Internet Connection");
      } else {
        PopInfo.snackbar(context, "Server Error");
      }
    }
  }
  return response;
